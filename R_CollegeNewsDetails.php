  ...
  <section id="about">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="news_details">
					<h2>A site visit to the College Farm</h2>
					<hr>
                    <img src="assets/rukshan/collegeNews/trinity-college-kandy_site-visit-to-the-college-farm-2020.jpg" alt="" class="img-responsive">
					<br>
                    <p>The Principal, Rev. Fr. Araliya Jayasundara OSB visited the College Farm on Wednesday, 
                        7th October and met with the farm manager 
                        Mr Chandra Amunugama to discuss the present state of work and future developments.</p>
                        <br>

                        <p>It was in the early 1950s Mr William Sinnathamby (called ‘Bill’ by his friends and ‘Sinna’ by his students),
                             with a new vision for promoting agriculture at Trinity, leased out land in Haragama to establish a 
                             new farm with the support of 
                            Principal Mr N.S. Walter and Vice Principal Major Gordon Burrows.</p>
                        <br>    
