...
<section id="service">
  ...
  <section id="about">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="news_details">
					...
					<hr>
                    <img src="assets/rukshan/collegeEvents/estructura-annual-maths-day-of-musaeus-college-2018.jpg" alt="" class="img-responsive">
					<br>
                    <p>The first prize giving of Museaus College has been held in the year 1836.
  ...
  <a href="R_CollegeEventsDetails.php" class="list-group-item list-group-item-action list-group-item-warning flex-column align-items-start">
    ...
    <p>The first prize giving of Museaus College has been held in the year 1836. From the inception, 
  ...
  <a href="R_CollegeEventsColours.php" class="list-group-item list-group-item-action list-group-item-warning flex-column align-items-start">
    ...
    <p>The colours night is considered a very special event in the calendar of Royal and is held in order to
        ...
        Museaus College boasts the fact that it’s very first colours night in 1922 was the first such
