  ...
  <section id="about">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="news_details">
					<h2>A gift to Trinity: the Battle Map of the Dutch invasion of Kandy, 1765.</h2>
					<hr>
                    <img src="assets/rukshan/collegeNews/trinity-college-kandy_battle-map-of-dutch-invasion-to-kandy.jpg" alt="" class="img-responsive">
					<br>
                    <p>Mr Pilapitiya visited the College again with a copy of a rare Battle Map of the Dutch invasion 
                        of Kandy in 1765. The map was given to College as a gift, and handed over to the Acting Principal 
                        Dr Nalin Wikramanayake and Co-Vice Principal Mr Ananda Marasinghe.</p>
                        <br>

                        <p>The map shows a detailed description of the trench lines and the gun batteries in and around 
                            the town of Kandy, which was used by the Kandyan army to attack the invading Dutch army in 1765.
                            The original map is available in Rijksmuseum, Amsterdam.</p>
                        <br>    

                        <p>The ‘William Sinnathamby Farm’ to call by its original name,
                             has survived through almost 70 years of ‘glad and melancholy’ days. 
                             The site visit on Wednesday proved to be productive in understanding the actual state of the farm,
                             which, to all those who visited, seemed very promising!</p>
                        <br> 

                        <p>Currently crops such as coconuts, bananas, papayas, turmeric, beans, corns, radishes, tomatoes, 
                            red onions, carrots and beets are grown. 
                            And, being a mixed farm, it has a considerable amount of livestock – cattle,
                             pigs, chickens, rabbits and goats.</p>
                        <br> 
